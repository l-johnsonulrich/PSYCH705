...
| `Group size combined` | Observed mean group size                        | Continuous nume      |
| `Day range (m)`       | Observed travel distance                        | Continuous nume      |
| `HR size average`     | Observed mean home range size                   | Continuous nume      |
