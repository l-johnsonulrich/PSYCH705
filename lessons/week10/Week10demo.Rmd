...
p2 <- glmmTMB(logECV ~ logHRS + logBodyMass + logLeaves + logFruit + log(foragingGS), data=primates)
...
estimate_slopes(p1, trend="logLeaves")
estimate_slopes(p1, trend="logFruit")

#interactions..
summary(primates$foragingGS)
estimate_slopes(p1, trend=c("logHRS"), by=list(foragingGS=seq(1,50, 10)))
